...
@onready var _resolution_option: OptionButton = $CenterContainer/PanelContainer/MarginContainer/Content/ResolutionOption
@onready var _fullscreen_check: CheckBox = $CenterContainer/PanelContainer/MarginContainer/Content/FullscreenCheck
@onready var _master_slider: HSlider = $CenterContainer/PanelContainer/MarginContainer/Content/MasterSlider
@onready var _music_slider: HSlider = $CenterContainer/PanelContainer/MarginContainer/Content/MusicSlider
@onready var _sfx_slider: HSlider = $CenterContainer/PanelContainer/MarginContainer/Content/SfxSlider
@onready var _master_value: Label = $CenterContainer/PanelContainer/MarginContainer/Content/MasterValue
@onready var _music_value: Label = $CenterContainer/PanelContainer/MarginContainer/Content/MusicValue
@onready var _sfx_value: Label = $CenterContainer/PanelContainer/MarginContainer/Content/SfxValue
...
func _connect_signals() -> void:
	...
	$CenterContainer/PanelContainer/MarginContainer/Content/Buttons/ApplyButton.pressed.connect(_on_apply_pressed)
	$CenterContainer/PanelContainer/MarginContainer/Content/Buttons/ResetButton.pressed.connect(_on_reset_pressed)
	$CenterContainer/PanelContainer/MarginContainer/Content/Buttons/BackButton.pressed.connect(_on_back_pressed)
